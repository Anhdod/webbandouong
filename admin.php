...
<head>
    <meta charset="UTF-8">
    <title>Quản trị viên - Trang tổng quan</title>
...
<body>
    ...
    <nav class="navbar">
        <ul  class="nav-left">
            ...
            <li><a href="admin/manage_orders.php">Quản lý đơn hàng</a></li>
            <li><a href="admin/manage_users.php">Quản lý người dùng</a></li>
            <li><a href="admin/admin_reviews.php">Reviews</a></li>
        ...
        <div id="product-list">
            <?php while ($row = $result->fetch_assoc()): ?>
                <div class="product-item">
                    ...
                    <a class="detail-btn" href="admin/tc.php?id=<?php echo $row['id']; ?>">Xem chi tiết</a>
                </div>
            <?php endwhile; ?>
        </div>
    </main>
